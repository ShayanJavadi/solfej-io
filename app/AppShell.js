...
import store, { firebaseProviderProps, history, persistor } from "./store";
import "./App.scss";
import {
                  ...
                  <QueryProvider>
                    <div className="solfej-app">
                      <div className="App">
                        ...
                        <Route path={EAR_TRAINING_MINOR_MAJOR_THIRD_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_THIRD_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_MINOR_MAJOR_THIRD_1_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_THIRD_1_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_MINOR_MAJOR_THIRD_2_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_THIRD_2_ID} />
                        ))} />
                        <Route path={MUSIC_THEORY_PERFECT_FIFTH_PERFECT_FROUTH_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                        ...
                        <Route path={EAR_TRAINING_PERFECT_FIFTH_PERFECT_FOURTH_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_PERFECT_FIFTH_PERFECT_FOURTH_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_PERFECT_FIFTH_PERFECT_FOURTH_1_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_PERFECT_FIFTH_PERFECT_FOURTH_1_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_PERFECT_FIFTH_PERFECT_FOURTH_2_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_PERFECT_FIFTH_PERFECT_FOURTH_2_ID} />
                        ))} />
                        <Route path={MUSIC_THEORY_MINOR_MAJOR_CHORD_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                        ...
                        <Route path={EAR_TRAINING_MINOR_MAJOR_CHORD_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_CHORD_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_MINOR_MAJOR_CHORD_1_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_CHORD_1_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_MINOR_MAJOR_CHORD_2_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_CHORD_2_ID} />
                        ))} />
                        <Route path={MUSIC_THEORY_MINOR_MAJOR_SECOND_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                        ...
                        <Route path={EAR_TRAINING_MINOR_MAJOR_SECOND_SCREEN} exact component={AuthenticatedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_SECOND_ID} />
                        )} />
                        <Route path={EAR_TRAINING_MINOR_MAJOR_SECOND_1_SCREEN} exact component={AuthenticatedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_SECOND_1_ID} />
                        )} />
                        <Route path={EAR_TRAINING_MINOR_MAJOR_SECOND_2_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_SECOND_2_ID} />
                        ))} />
                        <Route path={MUSIC_THEORY_INTERVALS_CHECKPOINT_ONE_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                        ...
                        <Route path={EAR_TRAINING_INTERVALS_BEGINNER_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_INTERVALS_BEGINNER_ID} />
                        ))} />
                        <Route path={MUSIC_THEORY_TRITONE_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                        ...
                        <Route path={EAR_TRAINING_TRITONE_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_TRITONE_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_TRITONE_1_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_TRITONE_1_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_TRITONE_2_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_TRITONE_2_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_DIMINISHED_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_DIMINISHED_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_DIMINISHED_1_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_DIMINISHED_1_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_DIMINISHED_2_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_DIMINISHED_2_ID} />
                        ))} />
                        <Route path={MUSIC_THEORY_DIMINISHED_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                        ...
                        <Route path={MUSIC_THEORY_MAJOR_SCALE_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                        ...
                        <Route path={MUSIC_THEORY_CHECKPOINT_I_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                        ...
                        <Route path={MUSIC_THEORY_SHARPS_AND_FLATS_SCREEN} exact component={AuthenticatedRouteProvider(
                        ...
                        <Route path={RHYTHM_TRANSCRIPTION_SCREEN_I} exact component={AuthenticatedRouteProvider(
                          props => <RhythmTranscriptionScreen {...props} lessonId={RHYTHM_TRANSCRIPTION_I_ID} />
                        )} />
                        <Route path={RHYTHM_TRANSCRIPTION_SCREEN_II} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <RhythmTranscriptionScreen {...props} lessonId={RHYTHM_TRANSCRIPTION_II_ID} />
                        ))} />
                        <Route path={RHYTHM_TRANSCRIPTION_SCREEN_III} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <RhythmTranscriptionScreen {...props} lessonId={RHYTHM_TRANSCRIPTION_III_ID} />
                        ))} />
                        <Route path={RHYTHM_TRANSCRIPTION_SCREEN_IV} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <RhythmTranscriptionScreen {...props} lessonId={RHYTHM_TRANSCRIPTION_IV_ID} />
                        ))} />
                        <Route path={RHYTHM_TRANSCRIPTION_SCREEN_V} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <RhythmTranscriptionScreen {...props} lessonId={RHYTHM_TRANSCRIPTION_V_ID} />
                        ))} />
                        <Route path={RHYTHM_TRANSCRIPTION_SCREEN_VI} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <RhythmTranscriptionScreen {...props} lessonId={RHYTHM_TRANSCRIPTION_VI_ID} />
                        ))} />
                        <Route path={RHYTHM_SCREEN} exact component={AuthenticatedRouteProvider(RhythmScreen)} />
                        <Route path={MUSIC_THEORY_RHYTHM_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                        ...
                        <Route path={MUSIC_THEORY_DOTTED_NOTES_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                        ...
                        <Route path={MUSIC_THEORY_MINOR_MAJOR_6THS_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                        ...
                        <Route path={MUSIC_THEORY_MINOR_MAJOR_6TH_CHORDS_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                        ...
                        <Route path={MUSIC_THEORY_MINOR_MAJOR_7THS_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                        ...
                        <Route path={MUSIC_THEORY_MINOR_MAJOR_7TH_CHORDS_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                        ...
                        <Route path={EAR_TRAINING_MINOR_MAJOR_6THS_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_6THS_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_MINOR_MAJOR_6THS_1_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_6THS_1_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_MINOR_MAJOR_6THS_2_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_6THS_2_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_MINOR_MAJOR_7THS_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_7THS_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_MINOR_MAJOR_7THS_1_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_7THS_1_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_MINOR_MAJOR_7THS_2_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <IntervalIdentificationScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_7THS_2_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_MINOR_MAJOR_6TH_CHORDS_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_6TH_CHORDS_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_MINOR_MAJOR_6TH_CHORDS_1_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_6TH_CHORDS_1_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_MINOR_MAJOR_6TH_CHORDS_2_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_6TH_CHORDS_2_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_MINOR_MAJOR_7TH_CHORDS_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_7TH_CHORDS_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_MINOR_MAJOR_7TH_CHORDS_1_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_7TH_CHORDS_1_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_MINOR_MAJOR_7TH_CHORDS_2_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_MINOR_MAJOR_7TH_CHORDS_2_ID} />
                        ))} />
                        <Route path={MUSIC_THEORY_DOMINANT_7TH_CHORD_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                        ...
                        <Route path={EAR_TRAINING_DOMINANT_7TH_CHORD_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_DOMINANT_7TH_CHORD_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_DOMINANT_7TH_CHORD_1_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_DOMINANT_7TH_CHORD_1_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_DOMINANT_7TH_CHORD_2_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_DOMINANT_7TH_CHORD_2_ID} />
                        ))} />
                        <Route path={MUSIC_THEORY_HALF_DIMINISHED_7TH_CHORD_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                        ...
                        <Route path={EAR_TRAINING_HALF_DIMINISHED_7TH_CHORD_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_HALF_DIMINISHED_7TH_CHORD_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_HALF_DIMINISHED_7TH_CHORD_1_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_HALF_DIMINISHED_7TH_CHORD_1_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_HALF_DIMINISHED_7TH_CHORD_2_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
                          props => <ChordQualityScreen {...props} lessonId={EAR_TRAINING_HALF_DIMINISHED_7TH_CHORD_2_ID} />
                        ))} />
                        <Route path={EAR_TRAINING_7TH_CHORD_SCREEN} exact component={AuthenticatedRouteProvider(SubscribedRouteProvider(
