...
export default () => {
    ...
    return (
        <BlogPostLayout blogData={blogData} hero={<Hero />}>
            ...
            <h2>1. Perfect Cadence (V -> I)</h2>
            <ImageContainer fullWidth bottomMarginOnly>
               <One />
            </ImageContainer>
            <p>The most common cadence in all of music, the perfect (authentic) cadence sounds the most “final” of them all. This is the happy ending where your musical story is satisfied and resolved; no cliffhangers, and all questions answered. </p>
            ...
            <h3>Examples of Perfect Cadence:</h3>
            ...
            <p>2. Bruno Mars - When I Was Your Man</p>
            <ImageContainer bottomMarginOnly>
