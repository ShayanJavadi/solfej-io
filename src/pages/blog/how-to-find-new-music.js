...
export default () => {
    ...
    return (
        <BlogPostLayout blogData={blogData} hero={<Hero />}>
            <p><i>This is a guest post by Henry Garrett - Henry is a software engineer by day (and sometimes by night), and co-founder of <b><a href="https://albumdaily.com/?ref=Solfej">Album Daily Newsletter</a></b>. He has always been fascinated by the power of music. He calls himself a music ‘researcher’, someone who constantly is looking for his next favorite artist/song. You can find him on twitter <b> <a href="https://twitter.com/garretthenrym">@garretthenrym </a></b> or through <b><a href="https://albumdaily.com/?ref=Solfej">Album Daily</a></b>.</i></p>
            <h2>Preface</h2>
            ...
            <h2><a href="https://albumdaily.com/?ref=Solfej_Blog">Album Daily</a></h2>
            <p>Okay, I admit it, this is a shameless plug.  But I created Album Daily (https://albumdaily.com/?ref=Solfej_Blog) to tackle this exact issue of algorithmic music discovery.  If you decide to subscribe to one of our two newsletters, distributed daily or weekly, you will be introduced to many different genres and artists.  I, along with my wife and co-founder Paige, spend hours and hours combing through music to highlight what we believe our audience will love, from all areas of the music industry.</p>
