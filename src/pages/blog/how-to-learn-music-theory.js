...
export default () => {
    ...
    return (
        <BlogPostLayout blogData={blogData} hero={<Hero />}>
            ...
            <p>You’ll never be “done” learning music theory. There will always be new things to learn, and new concepts to pick up. That being said, if you truly spend the time and learn the fundamentals of music theory, you can easily start utilizing it in a matter of weeks!</p>
            ...
            <p>No! Music theory is not necessary to play any instrument. There are amazing artists out there who know little or no music theory at all!</p>
            <p>Does it help? Absolutely. Knowing music theory can do wonders for your playing. It’ll make navigating your instrument much easier, and help you translate your ideas from your head onto your instrument with ease.</p>
            ...
            <p>You don’t! There’s so many musicians and producers out there making and producing great music. Your fingers or instruments, and especially your computer do not care whether or not you know any music theory and will make sound regardless.</p>
            <p>Music theory will however specially help you out if you’re a producer. It can make communicating ideas much easier as you have a common language with other musicians.</p>
            ...
            <p>That being said looking at music theory as a set of “rules” can be counter productive. It’s much more productive to look at music theory as a common language to communicate ideas rather than rules.</p>
